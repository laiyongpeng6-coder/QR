package com.qrscanfast.core.data.database

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.TypeConverters
import com.qrscanfast.core.data.database.converter.Converters
import com.qrscanfast.core.data.database.dao.HistoryDao
import com.qrscanfast.core.data.database.dao.ProductDao
import com.qrscanfast.core.data.database.entity.CachedProductEntity
 ...
 * by the Android Keystore via [com.qrscanfast.core.data.encryption.EncryptionKeyManager].
 ...
 * @see ProductDao
 * @see Converters
 * @see com.qrscanfast.core.data.encryption.EncryptionKeyManager
 */
@Database(
    entities = [
