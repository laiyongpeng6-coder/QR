...
import com.qrscanfast.core.data.database.FastQrScanDatabase
import com.qrscanfast.core.data.database.dao.HistoryDao
import com.qrscanfast.core.data.database.dao.ProductDao
import com.qrscanfast.core.data.encryption.EncryptionKeyManager
 ...
 * - [FastQrScanDatabase]: SQLCipher-encrypted Room database instance.
...
object DatabaseModule {
     ...
     * - Database file named [FastQrScanDatabase.DATABASE_NAME].
     *
     ...
     * @return A singleton [FastQrScanDatabase] instance.
     */
    @Provides
    @Singleton
    fun provideDatabase(
        ...
        return Room.databaseBuilder(
            context,
            FastQrScanDatabase::class.java,
            FastQrScanDatabase.DATABASE_NAME
        )
     ...
     */
    @Provides
    fun provideHistoryDao(database: FastQrScanDatabase): HistoryDao = database.historyDao()
     ...
     */
    @Provides
    fun provideProductDao(database: FastQrScanDatabase): ProductDao = database.productDao()

    /**
     * Provides the Jetpack DataStore instance for application preferences.
     *
     * The DataStore file is named `fast_qr_scan_preferences` and stores lightweight
    ...
    fun provideDataStore(@ApplicationContext context: Context): DataStore<Preferences> {
        return PreferenceDataStoreFactory.create {
            context.preferencesDataStoreFile("fast_qr_scan_preferences")
        }
    }
}
